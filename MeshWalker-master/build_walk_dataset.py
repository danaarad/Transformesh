...
# Cube Engraving
output_json = f"./data/walks/walks_cubes_test_walks_{RANDOM_WALK_PARAMS['num_walks_per_mesh']}_ratio_1V_scaled_rotated.json"
...
output_json = f"./data/walks/walks_cubes_train_dev_walks_{RANDOM_WALK_PARAMS['num_walks_per_mesh']}_ratio_1V_scaled_rotated.json"
generate_walks_from_dataset(dataset_name="cubes",
                            dataset_path="./data/cubes/",
                            data_split="train",
                            walk_params=RANDOM_WALK_PARAMS,
