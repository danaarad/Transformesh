...
visualize_mesh(mesh_file="./data/cubes/camel/train/camel_1.obj", show_edges=True, background="white")
# plot_random_walk(mesh_file="./data/shrec_16/gorilla/test/T478.obj",
#                  walk_file="./data/walks/walks_shrec16_test_walks_128_ratio_05V_scaled.json",
#                  walk_id="data/shrec_16/gorilla/test/T478.obj__12",
#                  walk_color="#66ff00",
#                  zoom=1.8)
